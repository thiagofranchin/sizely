  ...
  return (
    <div className="grid gap-5 [&>*]:min-w-0">
      ...
      <div className="grid gap-5 xl:grid-cols-[1.4fr_0.6fr] [&>*]:min-w-0">
        ...
        <div className="luxury-panel min-w-0 grid gap-4 p-5 sm:p-6">
          ...
          <div className="grid gap-3 xl:grid-cols-1">
            <div className="min-w-0 rounded-[1.35rem] border border-[var(--border-soft)] bg-[color:var(--surface-alt)] px-4 py-3">
              ...
              <p className="mt-1 text-sm text-[var(--text-strong)]">
                Distância na imagem:{" "}
                {referenceDistance
                  ? `${referenceDistance.toFixed(1).replace(".", ",")} px`
                  : "Aguardando marcação"}
              </p>
            </div>
            <div className="min-w-0 rounded-[1.35rem] border border-[var(--border-soft)] bg-[color:var(--surface-alt)] px-4 py-3">
              ...
              <p className="mt-1 text-sm text-[var(--text-strong)]">
                {scaleCmPerPixel
                  ? `${scaleCmPerPixel.toFixed(4).replace(".", ",")} cm/px`
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="inline-flex min-w-0 items-center gap-2 text-sm text-[var(--text-soft)]">
            ...
            <Button
              ...
              variant="outline"
              onClick={onReset}
              className="h-11 w-full rounded-full bg-white/80 px-4 text-sm sm:w-auto dark:bg-card/80"
            >
